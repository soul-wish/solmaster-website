...
<div
	class="flex min-h-screen flex-col bg-[#0C192B] bg-[url('/bg.webp')] bg-cover bg-center bg-no-repeat"
>
	<main
		class="mx-auto flex w-full max-w-screen-xl grow flex-col items-center gap-6 px-8 pt-8 lg:flex-row lg:px-32"
	>
		<div class="grow">
